...
<html lang="pt-br">
    <head>
        ...
        <title>Visualizar Fila de Tratadas</title>

        <script type="text/javascript">
            function botaoOKT(id){  
                var validar_os = $('#validar_os').val();
            $.ajax({
                url : "./modalTratadas.php",
                type : 'post',
                dataType : 'html',
        ...
        <form method="post" id="filtro">
            ...
            <table class="table table-bordered border-secondary table-striped">
                ...
                <tbody>
                    ...
                    <?php
                        $sql = "SELECT * FROM pci.vistoria where status = 'tratada' $filtro_uf $filtro_cidade $filtro_cdoRef $filtro_acessoRef $filtro_problema $filtro_status $filtro_date";
                        $qr = mysql_query($sql);
                        ...
                        <tr>
                            ...
                            <td style="margin: auto; padding: 0; margin: 0;">
                                <button type="button" style="width: 100%; height: 40px;" id="btn-img"
                                    ...
                                    data-target="#myModalvizualizar" onClick='botaoOKT(<?php echo $res['id']?>)'>
                                    Visualizar
                                </button>
                            </td>
